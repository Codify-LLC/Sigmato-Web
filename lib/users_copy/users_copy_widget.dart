...
class UsersCopyWidget extends StatefulWidget {
  const UsersCopyWidget({Key? key}) : super(key: key);

  @override
  _UsersCopyWidgetState createState() => _UsersCopyWidgetState();
}

class _UsersCopyWidgetState extends State<UsersCopyWidget> {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.contain,
                                image: Image.asset(
                                  'assets/images/Group_1000001939.png',
                                ).image,
                              ),
                            ),
                          ),
